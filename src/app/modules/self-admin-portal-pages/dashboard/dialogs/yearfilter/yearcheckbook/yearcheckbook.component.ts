...
@Component({
  selector: 'app-yearcheckbook',
  templateUrl: './yearcheckbook.component.html',
  styleUrls: ['./yearcheckbook.component.scss']
})
export class YearcheckbookComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<YearcheckbookComponent>,
