...
@Component({
  selector: 'app-yearbartwo',
  templateUrl: './yearbartwo.component.html',
  styleUrls: ['./yearbartwo.component.scss']
})
export class YearbartwoComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<YearbartwoComponent>,
