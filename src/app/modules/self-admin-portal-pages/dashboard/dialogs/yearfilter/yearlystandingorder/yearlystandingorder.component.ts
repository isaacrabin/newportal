...
@Component({
  selector: 'app-yearlystandingorder',
  templateUrl: './yearlystandingorder.component.html',
  styleUrls: ['./yearlystandingorder.component.scss']
})
export class YearlystandingorderComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<YearlystandingorderComponent>,
