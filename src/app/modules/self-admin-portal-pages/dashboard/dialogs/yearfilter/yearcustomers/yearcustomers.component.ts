...
@Component({
  selector: 'app-yearcustomers',
  templateUrl: './yearcustomers.component.html',
  styleUrls: ['./yearcustomers.component.scss']
})
export class YearcustomersComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<YearcustomersComponent>,
